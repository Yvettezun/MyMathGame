...
class Amateur3 : AppCompatActivity(), View.OnClickListener {

    private var mCurrentPosition:Int=11
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_amateur3)
        ...
        when(v?.id){ //when an option is clicked,
            ...
            R.id.submit_next->{ //if submit is clicked
                if(mSelectedOptionPosition==0){//no option clicked?
                    ...
                    when{ mCurrentPosition<=mQuestionsList!!.size-30 ->{//theres still questions left
                    ...
                    if(mCurrentPosition!=15){ //checks if questions left, then changes button
