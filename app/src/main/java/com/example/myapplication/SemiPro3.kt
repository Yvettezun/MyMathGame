...
class SemiPro3 : AppCompatActivity(), View.OnClickListener {

    private var mCurrentPosition:Int=26
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_semi_pro3)
        ...
        when(v?.id){ //when an option is clicked,
            ...
            R.id.submit_next->{ //if submit is clicked
                if(mSelectedOptionPosition==0){//no option clicked?
                    ...
                    when{ mCurrentPosition<=mQuestionsList!!.size-15 ->{//theres still questions left
                    ...
                    if(mCurrentPosition!=30){ //checks if questions left, then changes button
