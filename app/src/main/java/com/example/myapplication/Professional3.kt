...
class Professional3 : AppCompatActivity(), View.OnClickListener {

    private var mCurrentPosition:Int=41
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_professional3)
        ...
        when(v?.id){ //when an option is clicked,
            ...
            R.id.submit_next->{ //if submit is clicked
                if(mSelectedOptionPosition==0){//no option clicked?
                    ...
                    when{ mCurrentPosition<=45 ->{//theres still questions left
                    ...
                    if(mCurrentPosition!=45){ //checks if questions left, then changes button
