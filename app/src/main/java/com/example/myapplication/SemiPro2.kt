...
class SemiPro2 : AppCompatActivity(), View.OnClickListener {

    private var mCurrentPosition:Int=21
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_semi_pro2)
        ...
        when(v?.id){ //when an option is clicked,
            ...
            R.id.submit_next->{ //if submit is clicked
                if(mSelectedOptionPosition==0){//no option clicked?
                    ...
                    when{ mCurrentPosition<=mQuestionsList!!.size-20->{//theres still questions left
                    ...
                    if(mCurrentPosition!=25){ //checks if questions left, then changes button
