...
class Amateur2 : AppCompatActivity(), View.OnClickListener {
    private var mCurrentPosition:Int=6
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_amateur2)
        ...
        when(v?.id){ //when an option is clicked,
            ...
            R.id.submit_next->{ //if submit is clicked
                if(mSelectedOptionPosition==0){//no option clicked?
                    ...
                    when{ mCurrentPosition<=mQuestionsList!!.size-35 ->{//theres still questions left
                    ...
                    if(mCurrentPosition!=10){ //checks if questions left, then changes button
